...
import { View, Text, StyleSheet, Modal, TextInput, Avatar, Image, StatusBar,  SafeAreaView, ScrollView, Touchable } from 'react-native';
...
const RescheduleScreen = ({ navigation, route }) => {
    ...
    const onChange = (event, selectedDate) => {
        ...
        return (
            <View>
                <Text style={styles.subtitle0}>Date selected</Text>
            </View>
        );
    };
    ...
    const [chooseTime, setChooseTime] = useState('Select New Time:');
                        ...
                        <View style={[styles.bodyContainer, { marginTop: -10 }]}>
                            ...
                            <View style={styles.selectDocContainer}>
                                ...
                                >
                                    ...
                                    <Picker.Item label="Dr. Byun Baekhyun" value="bbh" color="gray" fontWeight= 'bold' />
                                </Picker>
                            </View>
                        </View>
                        ...
                        <View style={[{ zIndex: 300, marginTop: -50 }]}>
                            <TouchableOpacity onPress={showDatepicker}>
                                <View style={styles.selectDateContainer}>
                                    <Text style={styles.subtitle2}> Select New Date</Text>
                                </View>
                            </TouchableOpacity>
                            {/* </View> */}
                            {show && (
                        ...
                        <View style={[styles.bodyContainer, { marginTop: 2 }]}>
                            ...
                            <TouchableOpacity>
                                <View style={styles.selectBookContainer}>
                                    <Text style={styles.subtitle}>Reschedule Appointment
                            </Text>
