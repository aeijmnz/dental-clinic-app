...
const UserAccountScreen = ({ navigation, route }) => {
	...
	async onPressSignOut = () => {
		try {
			await logout()
			// .then(navigation.navigate('Navigator', { screen: 'Home'}))
						...
						<View style={styles.cardBody}>
							<View style={styles.cardBodyTop}>
								...
								<View style={styles.cardLeftSide}>
									...
									<Text style={styles.cardName}>Name: {user ? currentUser.given_name + currentUser.family_name : " Name"}</Text>
									<Text style={styles.cardTime}>Address: {user ? user.currentUser : "Not yet Provided"}</Text>
									<Text style={styles.cardTime}>Birthdate: {user ? currentUser.birthdate : "Not yet Provided"}</Text>
									<Text style={styles.cardService}>Email: {user ? currentUser.email : ": No info"}</Text>
